...
module.exports = async d => {
    ...
    const inside = code.split("$createSlashCommand[")[r].split("]")[0] 
    
    let [guildID, name, description, ...opts] = inside.split(";") 
    ...
    try {
        const request = await axios.post(d._api(`/applications/${d.client.user.id}/guilds/${guildID}/commands`), {
            name: name, 
